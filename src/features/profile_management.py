...
This module manages mod profiles that are game-specific and use the .pum
extension (JSON format), allowing users to save and load different mod configurations.
"""
import os
import json
import tkinter
